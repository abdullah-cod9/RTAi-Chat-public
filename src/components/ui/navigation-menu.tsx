...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-[99999] flex max-w-max flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute -left-20 top-full flex justify-center m-1 ")}>
